...
File: SuperMarioSunshineDataManagement.cpp
Description:
In the game, you need to collect 50 shines in order to face off against that evil Bowser once again! (Not completely true, but close enough for this project)
You can also collect blue coins, which then can be traded for more shines
For this project, you will develop a game data object that maintains shines and coins, and lets us know if Mario can head to Corona Mountain to finish things off
